Algoritmo Ejercicio_5_Matrices
	...
	// Crear una matriz donde la primera columna sea el nombre y la segunda el apellido.
	// debe de imprimir la información a modo de tabla 
	// l NOMBRE l Apellido l
	// l Julian l Pena     l
	...
	Para i<-1 Hasta 4 Con Paso 1 Hacer /// bucle para los datos de las filas
		para j<- 1 hasta 1 con paso 1 hacer /// bucle para los datos de las colunmnas
			Escribir "Fila ", i ,": ||", matriz_usuario[i,j], "||";
